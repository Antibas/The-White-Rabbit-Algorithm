...
from white_rabbit.utils.utils import get_entity_label, get_entity_similarity, get_property_label, get_wikidata_uri
...
def white_rabbit(model, entity1: str, entity2: str, acceptance_threshold: float=1.0):
    try:
        ...
        emit('response', {"status": 500, "error": e.__str__()})
        return round(time()-now), 0, 0, 0, []
